...
/**
* SumApp/_SumStub.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from Sum.idl
* lunes 17 de junio de 2019 16H50' COT
*/

public class _SumStub extends org.omg.CORBA.portable.ObjectImpl implements SumApp.Sum
{
  ...
  public double res (double n1, double n2)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("res", true);
                $out.write_double (n1);
                $out.write_double (n2);
                $in = _invoke ($out);
                double $result = $in.read_double ();
